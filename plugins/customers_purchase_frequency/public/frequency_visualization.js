...
export class CustomerFrequencyVisualizationProvider {
  ...
  async render(visData, visParams, status) {
    ...
    _.forEach(data, v => {
      ...
      v.gte5lt10Frequency =
        v.gte5lt10Orders === 0 ? 0 : formatNumber(v.gte5lt10Orders / v.gte5lt10Cusomers);
      ...
      v.gte3lt5Frequency =
        v.gte3lt5Orders === 0 ? 0 : formatNumber(v.gte3lt5Orders / v.gte3lt5Cusomers);
...
function formatNumber(value, precision) {
  ...
  const tmpPrecision = Math.pow(10, 8);
